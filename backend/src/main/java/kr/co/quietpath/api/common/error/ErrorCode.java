...
public enum ErrorCode {
    ...
    AI_SUMMARY_REGENERATION_LIMIT_EXCEEDED(HttpStatus.CONFLICT, "AI_SUMMARY_REGENERATION_LIMIT_EXCEEDED", "다시 요약하기는 최대 3회까지 가능합니다."),
    AI_SUMMARY_FEEDBACK_NOT_AVAILABLE(HttpStatus.CONFLICT, "AI_SUMMARY_FEEDBACK_NOT_AVAILABLE", "완료된 AI 회고에만 피드백을 남길 수 있습니다."),
